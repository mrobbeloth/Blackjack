...
TEST_OBJS2 := $(DESTINATION_DIR)test_bet.o $(DESTINATION_DIR)Card.o $(DESTINATION_DIR)Hand.o $(DESTINATION_DIR)Display.o $(DESTINATION_DIR)GameLogic.o
TEST_OBJS3 := $(DESTINATION_DIR)test_deck.o $(DESTINATION_DIR)Deck.o $(DESTINATION_DIR)Card.o $(DESTINATION_DIR)Display.o
TEST_OBJS4 := $(DESTINATION_DIR)test_hand.o $(DESTINATION_DIR)Hand.o $(DESTINATION_DIR)Card.o $(DESTINATION_DIR)Display.o
